...
void main() {
  test('discovery includes only active available launch candidates', () {
    ...
    // work-stress-21 is excluded from new discovery because it contains
    // unsupported physiological claims in the current seed copy.
    expect(types.where(isMvpJourneyCandidate).map((t) => t.id), ['1', '3']);
